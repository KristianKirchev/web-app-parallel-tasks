...
class MergeSortTest {
    ...
    private <T extends Number> void executeSort(int parallelism, List<T> array, Comparator<T> comparator) {
        try {
            ...
            pool.invoke(SortFactory.create(Objects.requireNonNull(AlgorithmType.MERGE), comparator, array));
    ...
    @Test
    public void givenSmallIntegerArray_whenMergeSort_thenSortArray() {
    ...
    @Test
    public void givenLargeIntegerArray_whenMergeSort_thenSortArray() {
    ...
    @Test
    public void givenLargerIntegerArray_whenMergeSort_thenSortArray() {
    ...
    @Test
    public void givenSingleIntegerArray_whenMergeSort_returnSameArray() {
    ...
    @Test
    public void givenSortedIntegerArray_whenMergeSort_returnSameArray() {
    ...
    @Test
    public void givenReverselySortedIntegerArray_whenMergeSort_returnSortedArray() {
    ...
    @Test
    public void givenSmallDoubleArray_whenMergeSort_returnSortedArray() {
    ...
    @Test
    public void givenLargeDoubleArray_whenMergeSort_returnSortedArray() {
    ...
    @Test
    public void givenSingleDoubleArray_whenMergeSort_returnSameArray() {
    ...
    @Test
    public void givenSortedDoubleArray_whenMergeSort_returnSameArray() {
    ...
    @Test
    public void givenReverselySortedDoubleArray_whenMergeSort_returnSortedArray() {
