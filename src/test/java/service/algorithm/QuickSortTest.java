...
class QuickSortTest {
    ...
    private <T extends Number> void executeSort(int parallelism, List<T> array, Comparator<T> comparator) {
        try {
            ...
            pool.invoke(SortFactory.create(Objects.requireNonNull(AlgorithmType.QUICK), comparator, array));
    ...
    @Test
    public void givenSmallIntegerArray_whenQuickSort_thenSortArray() {
    ...
    @Test
    public void givenLargeIntegerArray_whenQuickSort_thenSortArray() {
    ...
    @Test
    public void givenLargerIntegerArray_whenQuickSort_thenSortArray() {
    ...
    @Test
    public void givenSingleIntegerArray_whenQuickSort_returnSameArray() {
    ...
    @Test
    public void givenSortedIntegerArray_whenQuickSort_returnSameArray() {
    ...
    @Test
    public void givenReverselySortedIntegerArray_whenQuickSort_returnSortedArray() {
    ...
    @Test
    public void givenSmallDoubleArray_whenQuickSort_returnSortedArray() {
    ...
    @Test
    public void givenLargeDoubleArray_whenQuickSort_returnSortedArray() {
    ...
    @Test
    public void givenSingleDoubleArray_whenQuickSort_returnSameArray() {
    ...
    @Test
    public void givenSortedDoubleArray_whenQuickSort_returnSameArray() {
    ...
    @Test
    public void givenReverselySortedDoubleArray_whenQuickSort_returnSortedArray() {
